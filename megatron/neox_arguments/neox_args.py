...
class NeoXArgsModel(NeoXArgsTemplate):
    ...
    noise_seq_length: int = None
    """
    Maximum noise sequence length to process (for FIRE init_L).
    """

    mlp_width: int = None
    """
    The MLP Width (hidden dimension) for DAPEV1 with mlp opearation to process.
    """

    dapev2_kernel: int=3
    """
    The kernel size of dapev2 convolution operation
    """
    ...
    pos_emb: Literal[
        "learned", "rotary", "sinusoidal", "rpe", "alibi", "none",  "alibi_c", "fire", "fire_c", "xl_bias", "xl_bias_c", "kerple", "kerple_c",  "nope_c", "nope_c_ffn", "rope_dapev2", "rope_dapev1", "alibi_dapev2", "kerple_dapev2", "fire_dapev2", "cope",
    ] = "learned"
    """
